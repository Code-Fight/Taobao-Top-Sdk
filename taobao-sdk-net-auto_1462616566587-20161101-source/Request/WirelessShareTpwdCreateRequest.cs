...
namespace Top.Api.Request
{
    ...
    public class WirelessShareTpwdCreateRequest : BaseTopRequest<Top.Api.Response.WirelessShareTpwdCreateResponse>
    {
        ...
        public IsvTpwdInfoDomain TpwdParam_ { set { this.TpwdParam = TopUtils.ObjectToJson(value); } } 
        ...
        {
            RequestValidator.ValidateRequired("tpwd_param", this.TpwdParam);
        }

	/// <summary>
	/// IsvTpwdInfoDomain Data Structure.
	/// </summary>
	[Serializable]
	public class IsvTpwdInfoDomain : TopObject
	{
	        /// <summary>
	        /// 扩展字段JSON格式
	        /// </summary>
